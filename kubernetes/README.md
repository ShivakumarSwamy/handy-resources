...
- [k8s resources](#k8s-resources)
    ...
    * [create resources](#create-resources)
        ...
        + [create a deployment with 3 replicas in a namespace](#create-a-deployment-with-3-replicas-in-a-namespace)
        + [create a namespace](#create-a-namespace)
        + [create a config map](#create-a-config-map)
    * [run resources](#run-resources)
        + [create a headless pod with an interactive shell and never restart](#create-a-headless-pod-with-an-interactive-shell-and-never-restart)
